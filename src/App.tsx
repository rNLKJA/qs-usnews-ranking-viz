      ...
      <main className="flex min-w-0 flex-1 flex-col overflow-y-auto px-8 py-10 md:px-14 md:py-12">
        <header className="mb-8 max-w-3xl">
          <p className="text-[11px] uppercase tracking-widest text-muted-foreground">
            QS · U.S. News · Times Higher Education
          </p>
          ...
          <p className="mt-3 text-lg font-light leading-relaxed">
            Four rankings, four decades.{' '}
            <span className="text-[#ff3c3c]">See the trend, and where they disagree.</span>
          </p>
          <p className="mt-2 text-sm font-light leading-relaxed text-muted-foreground">
            Click a university for its rank trend across four systems. QS 2016–27, THE 2011–26, U.S.
            News Best Global 2026, and U.S. News National (U.S. only) back to 1984. Lower is better.
          </p>
        </header>
                ...
                {focusedUnis.length > 0 && (
                  <div className="mb-3 flex flex-wrap items-center gap-2 self-start border border-foreground px-3 py-1.5 text-[11px] uppercase tracking-widest">
                    ...
                    {focusedUnis.map((u) => (
                      <button
                        key={u.id}
                        onClick={() => toggleFocus(u.id)}
                        className="inline-flex items-center gap-1.5 hover:line-through"
                        title="Remove"
                      >
                        <span
                    ...
                    <button
                      ...
                      className="ml-1 font-semibold hover:text-[#ff3c3c]"
